...
function popClick(menuNum, itemNum)
{
 with (menu[menuNum][itemNum])
 {
  switch (type)
  {
   ...
   case 'both': {parent.left.location.href="t4.html";parent.main.location.href="text.html";break;}
...
menu[0][0] = new Menu(false, '', 80, 1, 17, 3, '#024B76', '#024B76', '', 'itemText');
//menu[0][1] = new Item('  Tutorials', 'tutorials.html', '', 50 , 20, 1);
menu[0][1] = new Item('  Case Studies', 'http://www.megaputer.com/company/pacases.php3', 'newwin', 86, 20, 2);
menu[0][2] = new Item('  Exploration Engines', 'http://www.megaputer.com/products/pa/algorithms/index.php3', 'newwin', 125, 20, 4);
//menu[0][3] = new Item('  Purchase', 'purchase.html', 'newwin', 60, 20, 0);

menu[2] = new Array();
menu[2][0] = new Menu(true, '&gt', 0, 22, 150, 3, defOver, defBack, 'itemBorder', 'itemText');
menu[2][1] = new Item('Direct Marketing', 'http://www.megaputer.com/company/cases/cactusstrategies.php3', '', defLen, 2, 0);
menu[2][2] = new Item('Market Basket Analysis', 'http://www.megaputer.com/company/cases/cambridge_mba.php3', 'newwin', defLen, 2, 0);
menu[2][3] = new Item('Marketing Intelligence', 'http://www.megaputer.com/company/cases/iu.php3', 'newwin', defLen, 2, 0);
menu[2][4] = new Item('Portfolio Management', 'http://www.megaputer.com/company/cases/securities.php3', 'newwin', defLen, 2, 0);
menu[2][5] = new Item('Currency Dealing', 'http://www.megaputer.com/company/cases/currency.php3', 'newwin', defLen, 2, 0);
menu[2][6] = new Item('Medical School', 'http://www.megaputer.com/company/cases/uw_med.php3', 'newwin', defLen, 2, 0);
menu[2][7] = new Item('Ulm Hospital', 'http://www.megaputer.com/company/cases/uu_hospital.php3', 'newwin', defLen, 2, 0);
menu[2][8] = new Item('Surgery Research', 'http://www.megaputer.com/company/cases/nrcs.php3', 'newwin', defLen, 2, 0);
menu[2][9] = new Item('Pittsburgh Hospital', 'http://www.megaputer.com/company/cases/puh.php3', 'newwin', defLen, 2, 0);
menu[2][10] = new Item('In-flight Control', 'http://www.megaputer.com/company/cases/boeing.php3', 'newwin', defLen, 2, 0);
menu[2][11] = new Item('InfoWorld Review', 'http://www.megaputer.com/press/articles/2000/pa_infoworld_review.php3', 'newwin', defLen, 2, 0);
menu[2][12] = new Item('Personnel Retention', 'http://www.megaputer.com/company/cases/dyn_corp.php3', 'newwin', defLen, 2, 0);

menu[4] = new Array();
menu[4][0] = new Menu(true, '&gt', 0, 22, 150, 3, defOver, defBack, 'itemBorder', 'itemText');
menu[4][1] = new Item('Summary Statistics', 'http://www.megaputer.com/products/pa/algorithms/ss.php3', 'newwin', defLen, 2, 0);
menu[4][2] = new Item('Linear Regression', 'http://www.megaputer.com/products/pa/algorithms/lr.php3', 'newwin', defLen, 2, 0);
menu[4][3] = new Item('Find Dependencies', 'http://www.megaputer.com/products/pa/algorithms/fd.php3', 'newwin', defLen, 2, 0);
menu[4][4] = new Item('Classify', 'http://www.megaputer.com/products/pa/algorithms/cl.php3', 'newwin', defLen, 2, 0);
menu[4][5] = new Item('Cluster', 'http://www.megaputer.com/products/pa/algorithms/fc.php3', 'newwin', defLen, 2, 0);
menu[4][6] = new Item('Decision Tree', 'http://www.megaputer.com/products/pa/algorithms/dt.php3', 'newwin', defLen, 2, 0);
menu[4][7] = new Item('Decision Forest', 'http://www.megaputer.com/products/pa/algorithms/df.php3', 'newwin', defLen, 2, 0);
menu[4][8] = new Item('Discriminate', 'http://www.megaputer.com/products/pa/algorithms/ds.php3', 'newwin', defLen, 2, 0);
menu[4][9] = new Item('Find Laws', 'http://www.megaputer.com/products/pa/algorithms/fl.php3', 'newwin', defLen, 2, 0);
menu[4][10] = new Item('Nearest Neighbor', 'http://www.megaputer.com/products/pa/algorithms/br.php3', 'newwin', defLen, 2, 0);
menu[4][11] = new Item('PolyNet Predictor', 'http://www.megaputer.com/products/pa/algorithms/pp.php3', 'newwin', defLen, 2, 0);
menu[4][12] = new Item('Market Basket Analysis ', 'http://www.megaputer.com/products/pa/algorithms/ba.php3', 'newwin', defLen, 2, 0);
menu[4][13] = new Item('Transactional Analysis ', 'http://www.megaputer.com/products/pa/algorithms/tba.php3', 'newwin', defLen, 2, 0);
menu[4][14] = new Item('Text Analysis ', 'http://www.megaputer.com/products/pa/algorithms/ta.php3', 'newwin', defLen, 2, 0);
...
function positionMenu()
{
 ...
 menu[0][0].ref.left = winWidth-260;
